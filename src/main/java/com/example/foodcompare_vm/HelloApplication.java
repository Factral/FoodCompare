...
public class HelloApplication extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Restaurant mcdonalds = new Restaurant(rest_doc.get("_id").toString(), rest_doc.getString("name"), rest_doc.getInteger("phonenumber"), rest_doc.getString("adress"));
        ...
        // burger king
        rest_doc = rest_collecion.find(new Document("name", "Burger King")).first();
        Restaurant burgerking = new Restaurant(rest_doc.get("_id").toString(), rest_doc.getString("name"), rest_doc.getInteger("phonenumber"), rest_doc.getString("adress"));
        ...
        Restaurant kfc = new Restaurant(rest_doc.get("_id").toString(), rest_doc.getString("name"), rest_doc.getInteger("phonenumber"), rest_doc.getString("adress"));
